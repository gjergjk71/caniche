...
export default function Home() {
  return (
    <main className={styles.main}>
        <Header/>
        <div className='' >
          <div style={{ position: "relative", display: 'inline-flex', marginLeft: "13vw"}} className={styles.DivWebMobile}>
    <div  style={{ marginRight: 15, position: 'absolute', top: '50%', msTransform: 'translateY(-50%)', transform: 'translateY(-50%)'}}>
        <img className="BellPeppers" style={{width: 608, height: 405, borderRadius: 2}} src="/imgs/venice.jpg" />
      <div className="Subheadline" style={{width: 443, textAlign: 'center', color: '#707070', fontSize: 25, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Just an extremely delicious looking ice-cream.</div>
    </div>
    <div  style={{marginLeft: '40vw', marginTop: '1vh'}}>
              <div className="WhoAreYou" style={{width: 501, color: 'black', fontSize: 64, fontFamily: 'Newsreader', fontWeight: '400', wordWrap: 'break-word'}}>Who are you?</div>
      <div className="Subheadline" style={{width: 443, color: '#707070', fontSize: 25, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>We want to get to know you</div>
      ...
      <div className="SocialMedia" style={{color: '#105A12', fontSize: 21, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>Social media</div>        
          <br/>
          <div className="CartButton" style={{width: 84, height: 48, paddingLeft: 23, paddingRight: 23, paddingTop: 13.50, paddingBottom: 13.50, background: '#426B1F', borderRadius: 8, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
        <div className="Save" style={{textAlign: 'center', color: 'white', fontSize: 16, fontFamily: 'Inter', fontWeight: '600', wordWrap: 'break-word'}}>Save</div>
      </div>
        </div>
        </div>
        </div>
